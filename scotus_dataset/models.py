...
class Transcript(Model):
    ...
    class Meta:
        ...
        indexes = ((("term", "docket", "file_name"), True),)
    ...
    def petitioner_statements(self):
        return [
            ...
            if statement.speaker_is_petitioner
        ]
    ...
    def respondent_statements(self):
        return [
            statement
            for statement in self.statements
            if statement.speaker_is_respondent
        ]
...
class Statement(Model):
    ...
    def speaker_is_justice(self):
        return (
            self.speaker.startswith("JUSTICE")
            or self.speaker.startswith("CHIEF JUSTICE")
            or (self.speaker == "QUESTION")
        )
